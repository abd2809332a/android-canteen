package com.example.android_canteen.common;
...
public class GlobalSet {
    ...
    // 镜像状态
    private static final String MIRROR_STATUS = "MIRROR_STATUS";
    ...
    public enum STRUCTURED_LIGHT {
        OBI_ASTRA_MINI, OBI_ASTRA_PRO, OBI_ATLAS, OBI_ASTRA_PRO_s1, OBI_ASTRA_DB, OBI_DEEYEA, HUAJIE_AMY_MINI
    }
    ...
    public static void setMirrorStatus(int status) {
        PreferencesUtil.putInt(MIRROR_STATUS, status);
    }

    public static int getMirrorStatus() {
        return PreferencesUtil.getInt(MIRROR_STATUS, 1);
    }
}
